    ...
    public static class ModelBuilderDataGenerator
    {
        public static void GenerateData(this ModelBuilder builder)
        {
            ...
            builder.Entity<Weapon>().HasData(
                ...
                new Weapon() { WeaponId = 3, Name = "Big Bertha", Description = "Grosse bombe", Force = 1000, Image = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR6TJJhKeAQBPeEFLuL10xugTp5-4G-sCyI593t2cf0jQ&s", Price = 1000, Qty = 2, QtyBought = 1, CreatedDate = new DateTime(1999, 01, 1) }
            );
            #endregion
        }
    }
